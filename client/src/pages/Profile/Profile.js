...
function Profile() {
	...
	const [, setNewAvatarURL] = useState("");
	...
	return (
		<React.Fragment>
				...
				<Grid container padding={1} rowSpacing={3} alignItems="center">
					<Grid item xs={12}>
						<Grid container alignItems="center" padding={1} spacing={2}>
							<Grid item xs={12}>
								<Stack>
									<AvatarPicker setAvatarUrl={setNewAvatarURL} />
								</Stack>
							</Grid>
							<Grid item xs={12}>
								{user.userType === "developer" ? (
									<Stack spacing={1}>
										...
										/>
										<Divider />
										<LanguagesPicker presetLanguages={true} />
										<Divider />
									</Stack>
								) : (
									<Stack>
			...
			<Dialog open={confirmDelete} onClose={handleConfirmDeleteClose}>
				<DialogTitle>
					<u>Are you sure you want to delete your profile?</u>
				</DialogTitle>
				<DialogActions>
					<FormControl fullWidth>
						<Stack
